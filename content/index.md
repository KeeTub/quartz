...
<div class="hero-container">
  <img src="/static/kainent.png" class="hero-image">
  <div class="hero-overlay">
    <h1>H KAINE DIATHEKE</h1>
    <p>수십 년의 목회와 연구를 담은 김기천 목사의 신약성경 번역</p>
  </div>
</div>
...
<div style="text-align: center; margin: 1.5rem 0;">
  <a href="NTpbsEn" style="font-size: 1.1rem; font-weight: 600;">
...
범례: 
> **( )**는 원문에는 없는 것으로 이해를 원활하게 하기 위해서 추가하거나 또는 다른 절에 있는 것을 옮겨온 것. 
> ""(= )**는 괄호 앞에 있는 구절은 원문에 있는 것이지만 번역할 때에 애매할 경우 괄호 안에 단어나 구절로 대체될 수 있음.
> **대괄호 [ ]**는 문장 흐름을 매끄럽기 하기 위해 생략해도 되기에 생략하거나 또는 번역상 다른 절로 이동해야 되는 구절 또는 문장
...
<div style="text-align: center; margin: 1.5rem 0;"> **"오직 성경으로(Sola Scriptura)"** 
</div>